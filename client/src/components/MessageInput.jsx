...
import { IoSend, IoCloseCircleOutline, IoImageOutline } from "react-icons/io5";
...
const MessageInput = ({ input, setInput, isListening, startListening, isLoading, handleSend, isSpeaking, stopSpeaking, image, setImage }) => {
  ...
  return (
    <form onSubmit={handleSend} className="relative flex flex-col max-w-4xl gap-2 p-2 mx-auto border shadow-xl group bg-slate-900 rounded-xl border-slate-800">
      ...
      <div className="flex items-end w-full gap-2">
        ...
        <div className="relative flex-1">
          <textarea
            ...
            placeholder={isListening ? "Listening..." : "Ask text or upload image..."}
            rows={1}
