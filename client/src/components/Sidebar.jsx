...
const Sidebar = ({ chats, activeChatId, onSelectChat, onNewChat, onDeleteChat, onTogglePin, onClearAll, onOpenSettings, onOpenPersonas, isOpen, isLoading, isInstallable, installApp }) => {
      ...
      <div className="flex flex-col h-full p-4">
        ...
        <div className="pt-4 mt-4 space-y-1 border-t border-slate-800/50">
          ...
          <div className="flex items-center gap-2 px-3 py-1 mt-2">
             ...
             <span className="text-[10px] text-slate-600 font-mono uppercase tracking-widest">Systems Online</span>
          </div>
        </div>
      </div>
    </div>
