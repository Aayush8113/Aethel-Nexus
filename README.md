...
* **Visual Architecture:** Native rendering of Mermaid.js diagrams generated by AI.
* **Chat Analytics:** Instantly view message counts, code block frequencies, and total tokens per chat.
* **Pro Layouts:** Toggle the sidebar completely closed on desktop to maximize editor viewing space.
* **Read Estimates:** Message timestamps now calculate reading time dynamically.